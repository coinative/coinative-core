...
describe('WalletCredentials', function () {
  ...
  describe('new (UUID)', function () {
    ...
    it('should set walletId', function () {
      expect(credentials.walletId).to.exist;
      expect(credentials.walletId.length).to.equal(HEX_LENGTH_256BITS);
    });
  ...
  describe('regression tests', function () {
    ...
    it('email@example.com | password', function () {
      ...
      expect(credentials.walletId).to.equal('800f33e335f4cfc0188f6304739a9b51dcdc76e89fde6e7b4a0522da5ebfe22a');
    });

    it('email@example.com | password123', function () {
      var credentials = new WC('email@example.com', 'password123');
      expect(credentials.walletId).to.equal('25e3300127e691d2e257244df307216fdb8b09c35bb1928c767c5640f03bfc25');
    });

    it('email2@example.com | password123', function () {
      var credentials = new WC('email2@example.com', 'password123');
      expect(credentials.walletId).to.equal('1cdf61ee42c7be5ffdca86e04e6efc4848de9730cac37f2999234aab972d6c35');
    });
    ...
    it('00000000-0000-0000-0000-000000000000 | password', function () {
      ...
      expect(credentials.walletId).to.equal('9da02d078df058dc1d5cdb21c6f40142dcef2a2978f4321545e26f9c0e4ffb42');
    ...
    it('00000000-0000-0000-0000-000000000000 | password123', function () {
      ...
      expect(credentials.walletId).to.equal('8b2c6645f86872101513cadfd40234114b13d153d080aa1c1cfc50cae5c960c4');
    ...
    it('0584e02a-7eb2-11e3-86a6-04a7c963dfc9 | password', function () {
      ...
      expect(credentials.walletId).to.equal('7a386216a56456fe680a84252685a6f3bab2896cdd582de69bc7138c8e77e03a');
    ...
    it('0584e02a-7eb2-11e3-86a6-04a7c963dfc9 | password123', function () {
      ...
      expect(credentials.walletId).to.equal('891f0acd3626a0df7e549a3e57498a7437fbb1c5114b0dfd3651e8d422cdc7f8');
