...
describe('Address', function () {
  ...
  describe('livenet', function () {
    it('pay-to-pubkey, from string', function () {
      ...
      expect(address.version).equal(bitcoin.config.versions.bitcoin.livenet.pubKey);
    ...
    it('pay-to-script-hash, from string', function () {
      ...
      expect(address.version).equal(bitcoin.config.versions.bitcoin.livenet.p2sh);
    ...
    it('pay-to-script-hash, from hash+version', function () {
      var address = new bitcoin.Address(hex.toBits('3442193e1bb70916e914552172cd4e2dbc9df811'), bitcoin.config.versions.bitcoin.livenet.p2sh);
  ...
  describe('testnet', function () {
    it('pay-to-pubkey, from string', function () {
      ...
      expect(address.isP2SH()).to.be.false;
      expect(address.version).equal(bitcoin.config.versions.bitcoin.testnet.pubKey);
    ...
    it('pay-to-script-hash, from string', function () {
      ...
      expect(address.isP2SH()).to.be.true;
      expect(address.version).equal(bitcoin.config.versions.bitcoin.testnet.p2sh);
